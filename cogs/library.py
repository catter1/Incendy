...
class TerralithDownloads(discord.ui.View):
	def __init__(self):
		super().__init__()
		self.add_item(discord.ui.Button(label='Datapack (1.19-1.19.3)', emoji=Constants.Emoji.PMC, url='https://www.planetminecraft.com/data-pack/terralith-overworld-evolved-100-biomes-caves-and-more/', row=0))
		...
		self.add_item(discord.ui.Button(label='All Versions (1.17-1.19.4)', emoji=Constants.Emoji.GITHUB, url='https://github.com/Stardust-Labs-MC/Terralith/releases', row=0))
		self.add_item(discord.ui.Button(label='All Versions (1.17-1.19.3)', emoji=Constants.Emoji.STARDUST, url='https://www.stardustlabs.net/version-library#Terralith', row=0))
		self.add_item(discord.ui.Button(label='Fabric/Forge (1.18-1.19.4)', emoji=Constants.Emoji.MODRINTH, url='https://modrinth.com/mod/terralith/versions', row=1))
		self.add_item(discord.ui.Button(label='Fabric/Forge (1.18-1.19.4)', emoji=Constants.Emoji.CURSEFORGE, url='https://www.curseforge.com/minecraft/mc-mods/terralith/files', row=1))
		self.add_item(discord.ui.Button(label='Biome Name Fix (1.18-1.19.4)', emoji=Constants.Emoji.MODRINTH, url='https://modrinth.com/resourcepack/stardust-biome-name-fix', row=2))
		self.add_item(discord.ui.Button(label='Remove Intro Message (1.17-1.19.4)', emoji=Constants.Emoji.MODRINTH, url='https://modrinth.com/datapack/remove-terralith-intro-message', row=2))
...
class IncendiumDownloads(discord.ui.View):
	def __init__(self):
		super().__init__()
		self.add_item(discord.ui.Button(label='Datapack (1.19-1.19.3)', emoji=Constants.Emoji.PMC, url='https://www.planetminecraft.com/data-pack/incendium-nether-expansion/', row=0))
		self.add_item(discord.ui.Button(label='All Versions (1.16.5-1.19.4)', emoji=Constants.Emoji.GITHUB, url='https://github.com/Stardust-Labs-MC/Incendium/releases', row=0))
		self.add_item(discord.ui.Button(label='All Versions (1.16.5-1.19.3)', emoji=Constants.Emoji.STARDUST, url='https://www.stardustlabs.net/version-library#Incendium', row=0))
		self.add_item(discord.ui.Button(label='Fabric/Forge (1.18.2-1.19.4)', emoji=Constants.Emoji.MODRINTH, url='https://modrinth.com/mod/incendium/versions', row=1))
		self.add_item(discord.ui.Button(label='Fabric/Forge (1.18.2-1.19.4)', emoji=Constants.Emoji.CURSEFORGE, url='https://www.curseforge.com/minecraft/mc-mods/incendium/files', row=1))
		self.add_item(discord.ui.Button(label='Optional Resource Pack (1.18.2-1.19.4)', emoji=Constants.Emoji.MODRINTH, url='https://modrinth.com/resourcepack/incendium-optional-resourcepack', row=2))
		self.add_item(discord.ui.Button(label='Biome Name Fix (1.18-1.19.4)', emoji=Constants.Emoji.MODRINTH, url='https://modrinth.com/resourcepack/stardust-biome-name-fix', row=2))
...
class NullscapeDownloads(discord.ui.View):
	def __init__(self):
		super().__init__()
		self.add_item(discord.ui.Button(label='Datapack (1.19-1.19.3)', emoji=Constants.Emoji.PMC, url='https://www.planetminecraft.com/data-pack/nullscape/', row=0))
		self.add_item(discord.ui.Button(label='All Versions (1.18.2-1.19.4)', emoji=Constants.Emoji.GITHUB, url='https://github.com/Stardust-Labs-MC/Nullscape/releases', row=0))
		self.add_item(discord.ui.Button(label='All Versions (1.18.2-1.19.3)', emoji=Constants.Emoji.STARDUST, url='https://www.stardustlabs.net/version-library#Nullscape', row=0))
		self.add_item(discord.ui.Button(label='Fabric/Forge (1.18.2-1.19.4)', emoji=Constants.Emoji.MODRINTH, url='https://modrinth.com/mod/nullscape/versions', row=1))
		self.add_item(discord.ui.Button(label='Fabric/Forge (1.18.2-1.19.4)', emoji=Constants.Emoji.CURSEFORGE, url='https://www.curseforge.com/minecraft/mc-mods/nullscape/files', row=1))
		self.add_item(discord.ui.Button(label='Biome Name Fix (1.18-1.19.4)', emoji=Constants.Emoji.MODRINTH, url='https://modrinth.com/resourcepack/stardust-biome-name-fix', row=2))
...
class StructoryDownloads(discord.ui.View):
	def __init__(self):
		super().__init__()
		self.add_item(discord.ui.Button(label='Datapack (1.19-1.19.3)', emoji=Constants.Emoji.PMC, url='https://www.planetminecraft.com/data-pack/structory/', row=0))
		self.add_item(discord.ui.Button(label='All Versions (1.18.2-1.19.4)', emoji=Constants.Emoji.GITHUB, url='https://github.com/Stardust-Labs-MC/Structory/releases', row=0))
		self.add_item(discord.ui.Button(label='All Versions (1.18.2-1.19.3)', emoji=Constants.Emoji.STARDUST, url='https://www.stardustlabs.net/version-library#Structory', row=0))
		self.add_item(discord.ui.Button(label='Fabric/Forge (1.18.2-1.19.4)', emoji=Constants.Emoji.CURSEFORGE, url='https://www.curseforge.com/minecraft/mc-mods/structory/files', row=1))
...
class TowersDownloads(discord.ui.View):
	def __init__(self):
		...
		self.add_item(discord.ui.Button(label='All Versions (1.19-1.19.4)', emoji=Constants.Emoji.GITHUB, url='https://github.com/Stardust-Labs-MC/Structory-Towers/releases', row=0))
		self.add_item(discord.ui.Button(label='Fabric/Forge (1.19-1.19.4)', emoji=Constants.Emoji.CURSEFORGE, url='https://www.curseforge.com/minecraft/mc-mods/structory-towers/files', row=1))
...
class ContinentsDownloads(discord.ui.View):
	def __init__(self):
		super().__init__()
		self.add_item(discord.ui.Button(label='Datapack (1.18.2-1.19.3)', emoji=Constants.Emoji.PMC, url='https://www.planetminecraft.com/data-pack/continents/', row=0))
		self.add_item(discord.ui.Button(label='All Versions (1.18.2-1.19.4)', emoji=Constants.Emoji.GITHUB, url='https://github.com/Stardust-Labs-MC/Continents/releases', row=0))
		self.add_item(discord.ui.Button(label='All Versions (1.18.2-1.19.3)', emoji=Constants.Emoji.STARDUST, url='https://www.stardustlabs.net/version-library#Continents', row=0))
		self.add_item(discord.ui.Button(label='Fabric/Forge (1.18.2-1.19.4)', emoji=Constants.Emoji.MODRINTH, url='https://modrinth.com/mod/continents/versions', row=1))
		self.add_item(discord.ui.Button(label='Fabric/Forge (1.18.2-1.19.4)', emoji=Constants.Emoji.CURSEFORGE, url='https://www.curseforge.com/minecraft/mc-mods/continents/files', row=1))
...
class AmplifiedDownloads(discord.ui.View):
	def __init__(self):
		super().__init__()
		self.add_item(discord.ui.Button(label='Datapack (1.19-1.19.3)', emoji=Constants.Emoji.PMC, url='https://www.planetminecraft.com/data-pack/amplified-nether-1-18/', row=0))
		self.add_item(discord.ui.Button(label='All Versions (1.16.5-1.19.4)', emoji=Constants.Emoji.GITHUB, url='https://github.com/Stardust-Labs-MC/Amplified-Nether/releases', row=0))
		self.add_item(discord.ui.Button(label='All Versions (1.16.5-1.19.3)', emoji=Constants.Emoji.STARDUST, url='https://www.stardustlabs.net/version-library#Amplified-Nether', row=0))
		self.add_item(discord.ui.Button(label='Fabric/Forge (1.18.2-1.19.4)', emoji=Constants.Emoji.MODRINTH, url='https://modrinth.com/mod/amplified-nether/versions', row=1))
		self.add_item(discord.ui.Button(label='Fabric/Forge (1.18.2-1.19.4)', emoji=Constants.Emoji.CURSEFORGE, url='https://www.curseforge.com/minecraft/mc-mods/amplified-nether/files', row=1))
