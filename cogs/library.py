...
class TerralithDownloads(discord.ui.View):
	def __init__(self):
		super().__init__()
		self.add_item(discord.ui.Button(label='Datapack (1.19-26.1.1)', emoji=Constants.Emoji.MODRINTH, url='https://modrinth.com/datapack/terralith/versions?l=datapack', row=0))
		self.add_item(discord.ui.Button(label='Datapack (1.21-26.1.1)', emoji=Constants.Emoji.SMITHED, url='https://smithed.net/packs/terralith', row=0))
		self.add_item(discord.ui.Button(label='Datapack (1.17-26.1.1)', emoji=Constants.Emoji.STARDUST, url='https://www.stardustlabs.net/version-library', row=0))
		#self.add_item(discord.ui.Button(label='Datapack (26.1.1)', emoji=Constants.Emoji.PMC, url='https://www.planetminecraft.com/data-pack/terralith-overworld-evolved-100-biomes-caves-and-more/', row=0))
		...
		# self.add_item(discord.ui.Button(label='Datapack (1.17-26.1.1)', emoji=Constants.Emoji.GITHUB, url='https://github.com/Stardust-Labs-MC/Terralith/releases', row=0))
		self.add_item(discord.ui.Button(label='Fabric/Neoforge (1.18-26.1.1)', emoji=Constants.Emoji.MODRINTH, url='https://modrinth.com/datapack/terralith/versions?l=fabric&l=forge&l=neoforge&l=quilt', row=1))
		self.add_item(discord.ui.Button(label='Fabric/Neoforge (1.18-26.1.1)', emoji=Constants.Emoji.CURSEFORGE, url='https://www.curseforge.com/minecraft/mc-mods/terralith/files', row=1))
		self.add_item(discord.ui.Button(label='Sparkles (1.18.2-26.1.1)', emoji=Constants.Emoji.MODRINTH, url='https://modrinth.com/resourcepack/sparkles', row=2))
		self.add_item(discord.ui.Button(label='Remove Intro Message (1.17-26.1.1)', emoji=Constants.Emoji.MODRINTH, url='https://modrinth.com/datapack/remove-terralith-intro-message', row=2))
...
class IncendiumDownloads(discord.ui.View):
	def __init__(self):
		...
		self.add_item(discord.ui.Button(label='Datapack (1.16.5-26.1.1)', emoji=Constants.Emoji.STARDUST, url='https://www.stardustlabs.net/version-library', row=0))
		...
		self.add_item(discord.ui.Button(label='Fabric/Neoforge (1.18.2-26.1.1)', emoji=Constants.Emoji.MODRINTH, url='https://modrinth.com/datapack/incendium/versions?l=fabric&l=forge&l=neoforge&l=quilt', row=1))
		self.add_item(discord.ui.Button(label='Fabric/Neoforge (1.18.2-26.1.1)', emoji=Constants.Emoji.CURSEFORGE, url='https://www.curseforge.com/minecraft/mc-mods/incendium/files', row=1))
		self.add_item(discord.ui.Button(label='Sparkles (1.18.2-26.1.1)', emoji=Constants.Emoji.MODRINTH, url='https://modrinth.com/resourcepack/sparkles', row=2))
...
class NullscapeDownloads(discord.ui.View):
	def __init__(self):
		super().__init__()
		self.add_item(discord.ui.Button(label='Datapack (1.18.2-26.1.1)', emoji=Constants.Emoji.MODRINTH, url='https://modrinth.com/datapack/nullscape/versions?l=datapack', row=0))
		self.add_item(discord.ui.Button(label='Datapack (1.18.2-26.1.1)', emoji=Constants.Emoji.STARDUST, url='https://www.stardustlabs.net/version-library', row=0))
		#self.add_item(discord.ui.Button(label='Datapack (26.1.1)', emoji=Constants.Emoji.PMC, url='https://www.planetminecraft.com/data-pack/nullscape/', row=0))
		#self.add_item(discord.ui.Button(label='Datapack (1.18.2-26.1.1)', emoji=Constants.Emoji.GITHUB, url='https://github.com/Stardust-Labs-MC/Nullscape/releases', row=0))
		self.add_item(discord.ui.Button(label='Fabric/Neoforge (1.18.2-26.1.1)', emoji=Constants.Emoji.MODRINTH, url='https://modrinth.com/datapack/nullscape/versions?l=fabric&l=forge&l=neoforge&l=quilt', row=1))
		self.add_item(discord.ui.Button(label='Fabric/Neoforge (1.18.2-26.1.1)', emoji=Constants.Emoji.CURSEFORGE, url='https://www.curseforge.com/minecraft/mc-mods/nullscape/files', row=1))
		self.add_item(discord.ui.Button(label='Sparkles (1.18.2-26.1.1)', emoji=Constants.Emoji.MODRINTH, url='https://modrinth.com/resourcepack/sparkles', row=2))
...
class StructoryDownloads(discord.ui.View):
	def __init__(self):
		super().__init__()
		self.add_item(discord.ui.Button(label='Datapack (1.19-26.1.1)', emoji=Constants.Emoji.MODRINTH, url='https://modrinth.com/datapack/structory/versions?l=datapack', row=0))
		self.add_item(discord.ui.Button(label='Datapack (1.18.2-26.1.1)', emoji=Constants.Emoji.STARDUST, url='https://www.stardustlabs.net/version-library', row=0))
		#self.add_item(discord.ui.Button(label='Datapack (26.1.1)', emoji=Constants.Emoji.PMC, url='https://www.planetminecraft.com/data-pack/structory/', row=0))
		#self.add_item(discord.ui.Button(label='Datapack (1.18.2-26.1.1)', emoji=Constants.Emoji.GITHUB, url='https://github.com/Stardust-Labs-MC/Structory/releases', row=0))
		self.add_item(discord.ui.Button(label='Fabric/Neoforge (1.19-26.1.1)', emoji=Constants.Emoji.MODRINTH, url='https://modrinth.com/datapack/structory/versions?l=fabric&l=forge&l=neoforge&l=quilt', row=1))
		self.add_item(discord.ui.Button(label='Fabric/Neoforge (1.18.2-26.1.1)', emoji=Constants.Emoji.CURSEFORGE, url='https://www.curseforge.com/minecraft/mc-mods/structory/files', row=1))
		self.add_item(discord.ui.Button(label='Sparkles (1.18.2-26.1.1)', emoji=Constants.Emoji.MODRINTH, url='https://modrinth.com/resourcepack/sparkles', row=2))
...
class TowersDownloads(discord.ui.View):
	def __init__(self):
		super().__init__()
		self.add_item(discord.ui.Button(label='Datapack (1.19-26.1.1)', emoji=Constants.Emoji.MODRINTH, url='https://modrinth.com/datapack/structory-towers/versions?l=datapack', row=0))
		self.add_item(discord.ui.Button(label='Datapack (1.19-26.1.1)', emoji=Constants.Emoji.STARDUST, url='https://www.stardustlabs.net/version-library', row=0))
		#self.add_item(discord.ui.Button(label='Datapack (1.19-26.1.1)', emoji=Constants.Emoji.PMC, url='https://www.planetminecraft.com/data-pack/structory-towers/', row=0))
		#self.add_item(discord.ui.Button(label='Datapack (1.19-26.1.1)', emoji=Constants.Emoji.GITHUB, url='https://github.com/Stardust-Labs-MC/Structory-Towers/releases', row=0))
		self.add_item(discord.ui.Button(label='Fabric/Neoforge (1.19-26.1.1)', emoji=Constants.Emoji.MODRINTH, url='https://modrinth.com/datapack/structory-towers/versions?l=fabric&l=forge&l=neoforge&l=quilt', row=1))
		self.add_item(discord.ui.Button(label='Fabric/Neoforge (1.19-26.1.1)', emoji=Constants.Emoji.CURSEFORGE, url='https://www.curseforge.com/minecraft/mc-mods/structory-towers/files', row=1))
		self.add_item(discord.ui.Button(label='Sparkles (1.18.2-26.1.1)', emoji=Constants.Emoji.MODRINTH, url='https://modrinth.com/resourcepack/sparkles', row=2))
...
class ContinentsDownloads(discord.ui.View):
	def __init__(self):
		super().__init__()
		self.add_item(discord.ui.Button(label='Datapack (1.18.2-26.1.1)', emoji=Constants.Emoji.MODRINTH, url='https://modrinth.com/datapack/continents/versions?l=datapack', row=0))
		self.add_item(discord.ui.Button(label='Datapack (1.18.2-26.1.1)', emoji=Constants.Emoji.STARDUST, url='https://www.stardustlabs.net/version-library', row=0))
		#self.add_item(discord.ui.Button(label='Datapack (26.1.1)', emoji=Constants.Emoji.PMC, url='https://www.planetminecraft.com/data-pack/continents/', row=0))
		#self.add_item(discord.ui.Button(label='Datapack (1.18.2-26.1.1)', emoji=Constants.Emoji.GITHUB, url='https://github.com/Stardust-Labs-MC/Continents/releases', row=0))
		self.add_item(discord.ui.Button(label='Fabric/Neoforge (1.18.2-26.1.1)', emoji=Constants.Emoji.MODRINTH, url='https://modrinth.com/datapack/continents/versions?l=fabric&l=forge&l=neoforge&l=quilt', row=1))
		self.add_item(discord.ui.Button(label='Fabric/Neoforge (1.18.2-26.1.1)', emoji=Constants.Emoji.CURSEFORGE, url='https://www.curseforge.com/minecraft/mc-mods/continents/files', row=1))
...
class AmplifiedDownloads(discord.ui.View):
	def __init__(self):
		super().__init__()
		self.add_item(discord.ui.Button(label='Datapack (1.18.2-26.1.1)', emoji=Constants.Emoji.MODRINTH, url='https://modrinth.com/datapack/amplified-nether/versions?l=datapack', row=0))
		self.add_item(discord.ui.Button(label='Datapack (1.16.5-26.1.1)', emoji=Constants.Emoji.STARDUST, url='https://www.stardustlabs.net/version-library', row=0))
		#self.add_item(discord.ui.Button(label='Datapack (26.1.1)', emoji=Constants.Emoji.PMC, url='https://www.planetminecraft.com/data-pack/amplified-nether-1-18/', row=0))
		#self.add_item(discord.ui.Button(label='Datapack (1.16.5-26.1.1)', emoji=Constants.Emoji.GITHUB, url='https://github.com/Stardust-Labs-MC/Amplified-Nether/releases', row=0))
		self.add_item(discord.ui.Button(label='Fabric/Neoforge (1.18.2-26.1.1)', emoji=Constants.Emoji.MODRINTH, url='https://modrinth.com/datapack/amplified-nether/versions?l=fabric&l=forge&l=neoforge&l=quilt', row=1))
		self.add_item(discord.ui.Button(label='Fabric/Neoforge (1.18.2-26.1.1)', emoji=Constants.Emoji.CURSEFORGE, url='https://www.curseforge.com/minecraft/mc-mods/amplified-nether/files', row=1))
...
class SparklesDownloads(discord.ui.View):
	def __init__(self):
		super().__init__()
		self.add_item(discord.ui.Button(label='Resourcepack (1.19-26.1.1)', emoji=Constants.Emoji.MODRINTH, url='https://modrinth.com/resourcepack/sparkles', row=0))
		self.add_item(discord.ui.Button(label='Resourcepack (1.20-26.1.1)', emoji=Constants.Emoji.SMITHED, url='https://smithed.net/packs/sparkles', row=0))
