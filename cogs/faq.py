    ...
    async def q(self, interaction: discord.Interaction, faq: str, public: bool = False):
        ...
        match faq:
            ...
            case "Ore Distribution":
                ...
                file = discord.File("images/ore.jpeg", filename="image.jpeg")
            ...
            case "Versions":
                ...
                file = discord.File("images/Version_Table.png", filename="image.png")
                embed.set_image(url="attachment://image.png")
            case _:
